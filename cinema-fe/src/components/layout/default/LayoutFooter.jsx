        ...
        <footer>
            {!isMobile ?
                <Container fluid className='p-0'>
                    <Row className='text-center border-2 border-bottom border-top p-2 w-100vh border-dark'>
                    ...
                    <Row className='d-flex border-4 border-bottom border-dark'>
                        <Col className="py-3">
                            <h5>PopCorn Couch</h5>
                        ...
                        <Col className="py-3">
                            ...
                            <ul className="ul-nav m-0 p-0 py-3">
                                ...
                                <li><Nav.Link as={Link} to="about"><img src={certificate} alt="" srcset="" /></Nav.Link></li>
                            </ul>
                        </Col>
                    ...
                    {isTablet &&
                        <Row className='border-4 border-bottom py-2 border-dark'>
                            <div className='p-2 text-center bg-secondary rounded-pill mx-5'>
                                <h5>Chăm sóc khách hàng</h5>
                                <ul className="ul-nav m-0 p-0 py-3">
                                    <li>Hotline: 1900 0000</li>
                                    <li>Giờ làm việc: 24/7 (Tất cả các ngày cả Lễ)</li>
            ...
            <Row className={(isTablet || isMobile ? ' flex-column text-center' : ' ').concat('py-3 justify-content-center align-items-center border-3 border-dark border-top')}>
                <Col sm="1" xs="1" md="1" className='m-auto'>
                    <Link to="/"><img src={logo} width="64px" height="64px" alt="" srcset="" /></Link>
                </Col>
                <Col>
                    <div>
